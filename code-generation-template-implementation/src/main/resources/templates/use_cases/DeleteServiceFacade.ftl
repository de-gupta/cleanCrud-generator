<#-- Template for generating DeleteServiceFacade class -->
package ${aggregate().basePackage()}.useCases.crud.delete.facade;
...
@Component
@Qualifier("${aggregate().beanNamePrefix()}DeleteServiceFacade")
final class ${aggregate().baseName()}DeleteServiceFacade extends
AbstractDeleteServiceFacade${"<"}Long, Long${">"}
implements DeleteServiceFacade${"<"}Long${">"}
{
${aggregate().baseName()}DeleteServiceFacade(
@Qualifier("${aggregate().beanNamePrefix()}DeleteService") final DeleteService${"<"}Long${">"} service,
