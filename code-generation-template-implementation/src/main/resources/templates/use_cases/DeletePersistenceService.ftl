...
final class ${modelName}DeletePersistenceService extends AbstractDeletePersistenceService${"<"}Long, UUID${">"}
implements DeletePersistenceService${"<"}Long${">"}
{
${modelName}DeletePersistenceService(
@Qualifier("${modelName?uncap_first}DeletePersistenceModelRepository") final DeletePersistenceModelRepository${"<"}UUID${">"} repository,
