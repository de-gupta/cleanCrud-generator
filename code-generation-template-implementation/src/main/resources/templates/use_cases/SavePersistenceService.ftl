...
@Service
final class ${modelName}SavePersistenceService
		extends
		AbstractSavePersistenceService${"<"}Long, ${modelName}DomainModel,
		UUID, ${modelName}PersistenceModel${">"}
		implements
		SavePersistenceService${"<"}Long, ${modelName}DomainModel${">"}
{
	${modelName}SavePersistenceService(
			...
			@Qualifier("${modelName?uncap_first}DomainPersistenceIDManagement") final
			DomainPersistenceIDManagement${"<"}Long, UUID${">"} idManagement
	)
	{
