...
@Component
@Qualifier("personVPersistenceToDomainConverter")
final class PersonVPersistenceToDomainConverter implements Function<String, Integer>
{
	@Override
	public Integer apply(final String persistenceValue)
	{
